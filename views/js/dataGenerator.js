...
/** @constant
 ...
 @default
 */
const PIZZA_IMAGE='images/pizza.png';

/** @constant
 @type {string}
 @default
 */
const MARK_START_FRAME = 'mark_start_frame';

/** @constant
 @type {string}
 @default
 */
const MARK_END_FRAME = 'mark_end_frame';

/** @constant
 @type {string}
 @default
 */
const MEASURE_FRAME_DURATION = 'measure_frame_duration';

/** @constant
 @type {string}
 @default
 */
const MARK_END_GENERATING = 'mark_end_generating';

/** @constant
 @type {string}
 @default
 */
const MEASURE_PIZZA_GENERATION = 'measure_pizza_generation';

/** @constant
 @type {string}
 @default
 */
const MARK_START_GENERATING = 'mark_start_generating';

/** @constant
 @type {string}
 @default
 */
const MARK_START_RESIZE = 'mark_start_resize';

/** @constant
 @type {string}
 @default
 */
const MARK_END_RESIZE = 'mark_end_resize';

/** @constant
 @type {string}
 @default
 */
const MEASURE_PIZZA_RESIZE = 'measure_pizza_resize';
